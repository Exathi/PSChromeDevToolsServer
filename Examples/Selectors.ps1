...
Invoke-CdpInputClickElement -CdpPage $CdpPage -Click 1 -FilterScript { $_.NodeName -eq 'button' } -Index -1

Start-Sleep 1
Write-Host 'By id'
Invoke-CdpPageNavigate -CdpPage $CdpPage -Url 'https://www.selenium.dev/selenium/web/click_tests/html5_submit_buttons.html'
Wait-CdpPageLifecycleEvent -InputObject $CdpPage -Events NetworkIdle
Invoke-CdpInputClickElement -CdpPage $CdpPage -Click 1 -FilterScript { $_.Attributes.Name -eq 'id' -and $_.Attributes.Value -eq 'internal_implicit_submit' }

Start-Sleep 1
Write-Host 'By text'
Invoke-CdpPageNavigate -CdpPage $CdpPage -Url 'https://www.selenium.dev/selenium/web/click_tests/html5_submit_buttons.html'
Wait-CdpPageLifecycleEvent -InputObject $CdpPage -Events NetworkIdle
Invoke-CdpInputClickElement -CdpPage $CdpPage -Click 1 -FilterScript { $_.NodeValue -eq 'Spanned Submit' }

Start-Sleep 1
Write-Host 'By query selector'
Invoke-CdpPageNavigate -CdpPage $CdpPage -Url 'https://www.selenium.dev/selenium/web/click_tests/html5_submit_buttons.html'
Wait-CdpPageLifecycleEvent -InputObject $CdpPage -Events NetworkIdle
$Node = Test-CdpSelector -CdpPage $CdpPage -Selector '[id=internal_span_submit]'
Invoke-CdpInputClickElement -CdpPage $CdpPage -Click 1 -Selector '[id=internal_span_submit]'

$Node.backendNodeId -eq $CdpPage.PageInfo['Node'].BackendNodeId
